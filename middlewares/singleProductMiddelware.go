...
// GetSingeProduct returns a single product based on id from products collection
...
// GetSuggestionsProducts get 4 random products as suggestions for single-product.html
